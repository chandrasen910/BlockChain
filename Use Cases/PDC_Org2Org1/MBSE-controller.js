...
class TokenController {
	...
	async addMBSEPrivateDetails(req, res, next) {
		try {
			...
			let stateTxn2 = contract.createTransaction('CreateDetailedMBSEModelPrivate2');
			stateTxn2.setEndorsingOrganizations('Org2MSP');
			let tx2 = await stateTxn2.submit(JSON.stringify(tokenDef));
	...
	async updateMBSEPrivateDetails(req, res, next) {
		try {
			...
			let stateTxn2 = contract.createTransaction('UpdateDetailedMBSEModelPrivate2');
			stateTxn2.setEndorsingOrganizations('Org2MSP');
			let tx2 = await stateTxn2.submit(JSON.stringify(tokenDef));
...
async deleteMBSEPrivateDetails(req, res, next) {
	try {
		...
		let stateTxn2 = contract.createTransaction('DeleteDetailedMBSEModelPrivate2');
		stateTxn2.setEndorsingOrganizations('Org2MSP');
		let tx2 = await stateTxn2.submit(JSON.stringify(tokenDef));
