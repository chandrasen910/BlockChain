...
func (contract *SmartContract) CreateDetailedMBSEModelPrivate(ctx contractapi.TransactionContextInterface, MBSEData string) (*Detailed, error) {
	...
	//we are checking the Organization role is " Developer Organization"  & User roles is "CSE"
	if orgRole != "DEVELOPER" || userRole != "CSE" {
		return nil, fmt.Errorf("Insufficient Roles! DEVELOPER & CSE roles are required.")
	}
...
func (contract *SmartContract) CreateDetailedMBSEModelPrivate2(ctx contractapi.TransactionContextInterface, MBSEData string) (*Detailed, error) {
...
func (contract *SmartContract) UpdateDetailedMBSEModelPrivate(ctx contractapi.TransactionContextInterface, MBSEData string) (err error) {
	...
	//we are checking the Organization role is " Developer Organization"  & User roles is "CSE"
	if orgRole != "DEVELOPER" || userRole != "CSE" {
		return fmt.Errorf("Insufficient Roles! DEVELOPER_Org & CSE roles are required.")
	}
...
func (contract *SmartContract) UpdateDetailedMBSEModelPrivate2(ctx contractapi.TransactionContextInterface, MBSEData string) (err error) {
...
func (contract *SmartContract) DeleteDetailedMBSEModelPrivate2(ctx contractapi.TransactionContextInterface, MBSEData string) (err error) {
...
// // Read Detialed funtcion for MBSE Model and applying Private Data collection on org1
// func (contract *SmartContract) GetDetailedMBSEModelPrivate2(ctx contractapi.TransactionContextInterface, MBSEData string) (*Detailed, error) {
